...
namespace YmPhp\YmAdmin\Console;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install the ym-admin package';
    ...
    public function initDatabase()
    {
        ...
        if ($userModel::count() == 0) {
            $this->call('db:seed', ['--class' => \YmPhp\YmAdmin\Auth\Database\AdminTablesSeeder::class]);
        }
    }
